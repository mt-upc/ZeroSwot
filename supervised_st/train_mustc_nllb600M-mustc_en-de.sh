...
lang_pair=en-de
experiment_name=st_mustc_nllb600M-mustc_${lang_pair}
experiment_path=${SAVE_DIR}/st/${experiment_name}
ckpt_dir=${experiment_path}/ckpts
zs_experiment_path=${SAVE_DIR}/speech_encoders/mustc_w2v-Lrg_nllb600M-mustc
decoder_path=${SAVE_DIR}/mt_models/mt_nllb600M_MUSTC_v1.0_mult/ckpts/avg_best_10_checkpoint.pt
