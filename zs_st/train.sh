...
exp_path=${SAVE_DIR}/speech_encoders/${WANDB_NAME}
...
base_update_freq=$(grep 'update_freq:' ${ZS_ROOT}/zs_st/exp_configs/${WANDB_NAME}.yaml | awk '{print $2}' | sed 's/[^0-9]//g')
...
fairseq-hydra-train \
    --config-dir ${ZS_ROOT}/zs_st/exp_configs \
