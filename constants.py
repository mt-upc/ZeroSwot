MUSTC_NAME = "MUSTC_v1.0"
COVOST_NAME = "CoVoST2"
CV_NAME = "CommonVoice"
LS_NAME = "LibriSpeech"
DATASETS = [MUSTC_NAME, COVOST_NAME, CV_NAME, LS_NAME]
SPLITS = {
    MUSTC_NAME: ["train", "dev", "tst-COMMON"],
    COVOST_NAME: ["train", "dev", "test"],
    CV_NAME: ["train", "dev", "test"],
    LS_NAME: ["train-clean-100", "train-clean-360", "train-other-500", "dev-clean", "dev-other", "test-clean", "test-other"],
}
MODELS = [
...
TGT_LANGS = {
    MUSTC_NAME: ["de", "es", "fr", "it", "nl", "pt", "ro", "ru"],
    COVOST_NAME: ["ar", "ca", "cy", "de", "et", "fa", "id", "ja", "lv", "mn", "sl", "sv-SE", "ta", "tr", "zh-CN"]
}
NLLB_LANG_CODES = {
    "en": "eng_Latn",
    "de": "deu_Latn",
